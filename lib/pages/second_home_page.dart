...
import 'package:stadiaapp/common/popular_with_friends_game_widget.dart';
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          textAlign:TextAlign.center,
                                text:TextSpan(
                                  children: [TextSpan(
                                    text: "NEW GAME", style: newGameNameTextStyle
                                  ),
                        TextSpan(text:"\n"),
                        TextSpan(
                          text: "God Of War: Ghost of Sparta",style: newGameNameTextStyle
                        ),
                                  ],
                                ) ,
                            ),
                          ...
                          child: Row(
                            children: <Widget>[
                              for(var i=0; i<popularWithFriends.length;i++)
                                PopularWithFriendsWidget(imagePath: popularWithFriends[i],)
                            ],
                          ),
                    ),
                    ),
